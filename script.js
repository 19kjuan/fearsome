  ...
  $(function() {
    ...
    death = () => {
      ...
      return setTimeout((() => {
        ...
        this.$resultPS.html("Juego Terminado");
    ...
    reset = () => {
      // detener el juego si no hay reacción
      death();
    ...
    showDuelInfo = () => {
      ...
      switch (this.level) {
        case 3:
          this.$messagePS.html("Big Gilly Boulder anhela el trabajo de azotar a alguien como tú. ¡Es un experto en el duelo! Ten cuidado");
          break;
        case 2:
          this.$messagePS.html("Me llamo Goldie Gaia. Dirige el salón aunque tenga que mandarte al cementerio con las botas puestas.");
          break;
        default:
          this.$messagePS.html("Pumpgun Ed no es un hombre con quien jugar. Crees que este grandote te tira sobre el poste y te hace pedazos.");
      }
    ...
    noHonor = () => {
      ...
      // si se hizo clic demasiado temprano
      clearInterval(this.$duel);
      this.$duelButton.removeClass("is-hidden");
      this.$drawButton.addClass("is-hidden");
      switch (this.noHonor) {
        case 1:
          noHonorMessage = "No quieres ser demasiado rápido con el trío. Ellos deben sacar primero.";
          this.noHonor++;
          break;
        case 2:
          noHonorMessage = "Seguro estás jugando con suerte. Mejor vete a mover tus cobijas.";
          this.noHonor++;
          break;
        default:
          ...
          switch (random) {
            case 1:
              noHonorMessage = "¡Jugando con algo de suerte! ¡Y en esta hora del día!";
              break;
            case 2:
              noHonorMessage = "Pasó algo repentino, ¿verdad?";
              break;
            default:
              noHonorMessage = "¡Qué demonios! ¿Qué tipo de cosa no tiene honor en un rápido duelo?";
          }
      }
    ...
    enterOutro = () => {
      this.$totalTime.html("Tiempo total: " + this.totalTime.toFixed(3) + " segundos");
      this.$playScreen.addClass("is-hidden");
